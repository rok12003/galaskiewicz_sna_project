...
setwd("/Users/rohitkandala/Desktop/UChicago/Academic Quarters/2023-24/Spring 2024/MACSS 40101/Project")
...
org_df <- read.csv("Data/Affiliation Matrix - Orgs.csv")
education_df <- read.csv("Data/Affiliation Matrix - Education.csv")
ceo_attr_df <- read.csv("Data/Affiliation Matrix - CEO_Attr.csv")
org_attr_df <- read.csv("Data/Affiliation Matrix - Org_Attr.csv")
educ_attr_df <- read.csv("Data/Affiliation Matrix - Ed_Attr.csv")
...
# Save objects to an RData file for analysis:
save(org_net, education_net, gal_1978, org_matrix, education_matrix,
     file = "Data/allnetworks.RData")